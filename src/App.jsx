    ...
    <div className="flex flex-col min-h-screen justify-center font-display text-center">
      ...
      <div className='flex flex-col justify-center items-center bg-bg-gray pt-42 md:w-full'>
        ...
        <div className='flex flex-col md:flex-row justify-center md:justify-between items-center md:w-[1110px] md:mb-30'>
          <div className='relative flex flex-col justify-center items-center md:items-start w-[327px] md:w-[350px] h-[268px] bg-white rounded-md mt-8 md:mt-0 mb-14 md:mb-0 px-5 md:px-7 md:text-left'>
          ...
          <div className='relative flex flex-col justify-center items-center md:items-start w-[327px] md:w-[350px] h-[268px] bg-white rounded-md mt-8 md:mt-22 mb-14 md:mb-0 px-5 md:px-7 md:text-left'>
